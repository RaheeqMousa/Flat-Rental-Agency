                    ...
                    <div class="row gap-16 width-100">
                        <div class="row justify-content-center flex-direction-column py-32 px-16 shadow border-16 gap-16">
                            ...
                            <section class="row width-100">
                                ...
                                <input placeholder="Enter new name" id="name" name="name" pattern="^[A-Za-z]+$" type="text" value="<?php echo $customer['name'] ?>">
                            </section>
                            <section class="row width-100">
                    ...
                    <p class="error">
                        ...
                        <?php
                            if($_SESSION['user']['role']==='customer')
                                ...
                                echo "<button type='submit' disabled class='disabled-button'>Update Profile</button>";
                        ?>    
                </form>
            </main>
