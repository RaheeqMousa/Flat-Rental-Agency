<?php
    ...
    if (isset($_POST["email"]) && isset($_POST["name"]) && isset($_POST["password"]) && isset($_POST["confirm-pass"])) {
        ...
        echo $email." ".$password." ".$confirm_password." ".$name;
        if($statement->fetchColumn()>0){
            ...
            header("Location:CustomerRegisterStep3.php");
        }
            ...
            <form method="post" action="CustomerRegisterStep2.php">
                ...
                <section class="row gap-16 flex-direction-column shadow border-16 py-32 px-32">
                    ...
                    <div class="row width-100">
                        ...
                        <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($name); ?>" required class="required">
                    </div>

                    <div class="row width-100">
                        <label for="email">Email:</label>
                        <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($email); ?>" required class="required">
                    </div>
