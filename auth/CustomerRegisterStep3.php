<?php
    ...
    $name=$_SESSION['eaccount']['name'];
     ...
     if (isset($_POST["confirm"])) {
            ...
            $statement->bindValue(':title','Customer ID');
    ...
    <body>
        ...
        <section class="page-navigation-main">
            ...
            <main class="forms-style">
                ...
                <form method="post" action="CustomerRegisterStep3.php">
                    <section class="row gap-16 flex-direction-column shadow border-16 py-32 px-32">
                        <h2 class="mb-8">Customer Step-3 Registeration</h2>

                        <div class="row width-100">
                            <label for="name">Username:</label>
                            <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($name); ?>" required disabled>
</div>
