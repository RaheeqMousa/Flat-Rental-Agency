...
<html lang="en">
    ...
    <body>
        ...
        <main class="forms-style">
            ...
            $form = $_POST ?? []; // If form submitted, use submitted data
            $form = array_merge($_SESSION['register'] ?? [], $form); // fallback to session if available
            ?>

            <form method="post" action="CustomerRegisterStep1.php" enctype="multipart/form-data" class="row gap-16">
                <h2>Customer Step-1 Registration (Personal Information)</h2>
                <div class="row gap-32 justify-content-center">
                    ...
                    <section class="row flex-direction-column gap-16 shadow border-16 py-32 px-16">
                        ...
                        <div class="row width-100">
                            ...
                            <input type="text" id="nationalID" required name="National_ID" class="required"
                                placeholder="Enter National ID"
                                value="<?php echo htmlspecialchars($form['National_ID'] ?? ''); ?>">
                        </div>
                        ...
                        <div class="row width-100">
                            ...
                            <input id="name" name="name" required type="text" pattern="^[A-Za-z]+$"
                                title="Please enter only letters (A-Z or a-z), spaces not allowed" class="required"
                        ...
                        <div class="row width-100">
                            ...
                            <input id="dob" name="dob" required class="required" type="date" placeholder="Enter your DOB"
                    ...
                    <section class="row flex-direction-column gap-16 shadow border-16 py-32 px-16">
                        ...
                        <div class="row width-100">
                            ...
                            <input id="house_number" name="house_number" required class="required" type="text"
                                placeholder="Enter House Number" value="<?php echo htmlspecialchars($form['house_no'] ?? ''); ?>">
                        </div>

                        <div class="row width-100">
                            <label for="street_name">Street Name:</label>
                            <input id="street_name" name="street_name" required class="required"
                                placeholder="Enter street name" value="<?php echo htmlspecialchars($form['street_name'] ?? ''); ?>">
                        </div>

                        <div class="row width-100">
                            <label for="city">City:</label>
                            <input id="city" name="city" required class="required" type="text" placeholder="Enter city"
                                value="<?php echo htmlspecialchars($form['city'] ?? ''); ?>">
                        </div>

                        <div class="row width-100">
                            <label for="postal_code">Postal Code:</label>
                            <input id="postal_code" name="postal_code" required class="required" type="text"
                                placeholder="Enter Postal Code" value="<?php echo htmlspecialchars($form['postal_code'] ?? ''); ?>">
                        </div>
                    </section>
                    ...
                    <section class="row flex-direction-column gap-16 shadow border-16 py-32 px-16">
                        ...
                        <div class="row width-100">
                            ...
                            <input id="mobile_number" name="mobile_number" required class="required" type="text"
                                placeholder="Enter Mobile Number" value="<?php echo htmlspecialchars($form['mobile_number'] ?? ''); ?>">
                        </div>

                        <div class="row width-100">
                            <label for="tel_number">Telephone number:</label>
                            <input id="tel_number" name="tel_number" required class="required" type="text"
                                placeholder="Enter Telephone Number" value="<?php echo htmlspecialchars($form['telephone_number'] ?? ''); ?>">
                        </div>

                        <div class="row width-100">
                            <label for="email">Email:</label>
                            <input type="email" name="email" id="email" required class="required" placeholder="Enter email address"
