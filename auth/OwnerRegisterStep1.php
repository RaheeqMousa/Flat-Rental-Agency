        ...
        <section class="page-navigation-main">
            ...
            <main class="forms-style">
                ...
                <form method="post" action="OwnerRegisterStep1.php" enctype="multipart/form-data" class="row gap-16">
                    <h2>Owner Step-1 Registeration</h2>
                    <div class="row gap-32 justify-content-center">
                        <section class="row flex-direction-column gap-16 shadow border-16 py-32 px-16">
                            ...
                            <div class="row width-100">
                                ...
                                <input type="text" id="nationalID" required class="required" name="National_ID" placeholder="Enter National ID" value="<?php isset( $_SESSION['register']['national_id'])?? $_SESSION['register']['national_id'] ?>">  
                            </div>    
                    
                            <div class="row width-100">
                                <label for="name">Name:</label>
                                <input id="name" name="name" required class="required" type="text" pattern="^[A-Za-z]+$" placeholder="Enter your Username" value="<?php isset( $_SESSION['register']['username'])?? $_SESSION['register']['username'] ?>">
                            </div>
                    ...
                    <div class="row width-100">
                        ...
                        <input id="postal_code" name="postal_code" required class="required" type="text" placeholder="Enter Postal Code" value="<?php isset( $_SESSION['register']['postal_code'])?? $_SESSION['register']['postal_code'] ?>">
</div>
</section>
      <section class="row flex-direction-column gap-16 shadow border-16 py-32 px-16">
